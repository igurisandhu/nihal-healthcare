import{n as e,t}from"./footer-CFOVKqMt.js";import{n,t as r}from"./ScrollTrigger-N39Bzxb5.js";import{t as i}from"./navbarAnimation-BVUa5AKH.js";import{t as a}from"./navbarFunctionality-BGGaZaf6.js";import{n as o,t as s}from"./productsAnimation-DQz3VEN5.js";import{n as c,t as l}from"./leadershipAnimation-D-WJbRQI.js";import{n as u,t as d}from"./feedback-CKdOT7rd.js";import{t as f}from"./footerAnimation-VMZc8zZ3.js";import{n as p,t as m}from"./certificationsAnimations-uettMGoJ.js";import{t as h}from"./blogsGrid-DYXSboR-.js";import{t as g}from"./about-8H9DB-Hp.js";import{n as _,t as v}from"./pageMetadata-B4kUU4O2.js";import{f as y,i as b,m as x,s as S,u as C}from"./seoMeta-DNj-lsNH.js";var w=`/assets/hero-1-DP918TK8.jpg`,T=`/assets/hero-2-DwOaF9jL.avif`,E=`/assets/hero-3-ejHO0v_v.avif`,D=`/assets/hero-4-DLpmizSW.jpg`,O=()=>`
  ...
  `,k=()=>{n.timeline().from(`.hero-title`,{y:100,opacity:0,duration:1,ease:`power4.out`}).from(`.hero-desc`,{y:40,opacity:0,duration:.8},`-=0.5`).from(`#hero-image`,{scale:1.2,opacity:0,duration:1.2,ease:`power4.out`},`-=0.8`)},A=()=>{let e=document.querySelector(`#hero-image`),t=[w,T,E,D],n=0;setInterval(()=>{n++,n>=t.length&&(n=0),e.style.opacity=0,setTimeout(()=>{e.src=t[n],e.style.opacity=1},300)},2e3)};n.registerPlugin(r);var j=()=>{window.innerWidth>=1024&&n.from(`.testimonial-card`,{y:80,opacity:20,stagger:.2,duration:1,ease:`power4.out`,scrollTrigger:{trigger:`.testimonials-section`,start:`top 75%`}})},M=()=>`
  ...
  `;n.registerPlugin(r);var N=()=>{window.innerWidth>=1024&&n.from(`.contact-cta-title`,{y:80,opacity:0,duration:1,ease:`power4.out`,scrollTrigger:{trigger:`.contact-cta-section`,start:`top 75%`}})},P=()=>`
