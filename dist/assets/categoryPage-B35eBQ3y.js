...
import{_ as e,a as t,g as n,h as r,i,t as a,u as o,v as s}from"./gtm-BuJCn9KU.js";import{t as c}from"./navbarAnimation-nIwfTKzd.js";import{t as l}from"./navbarFunctionality-DYFdrxFV.js";import{t as u}from"./footerAnimation-DKeORBd-.js";import{n as d,t as f}from"./whatsappButtonFunctionality-DXb-Cey1.js";import{t as p}from"./preload-helper-DX1F7c5z.js";function m(e){r(o(e,!1)),n([t(e,e.variants),i([{name:`Home`,url:`https://nihalhealthcare.com/`},{name:`Products`,url:`https://nihalhealthcare.com/products.html`},{name:e.name}])]);let a=e.variants.map(e=>{let t=e.size||e.gauge,n=e.needleGauges?`${e.needleGauges.length} gauge options`:e.gauge?`Single gauge`:`Multiple sizes`,r=e.image||`https://images.unsplash.com/photo-1584308666744-24d5f15714ae?w=400&h=300&fit=crop`;return`
  ...
  `}a();async function h(t){let{getCategoryWithVariants:n}=await p(async()=>{let{getCategoryWithVariants:e}=await import(`./productsDatabase-CcTIPkxC.js`).then(e=>e.n);return{getCategoryWithVariants:e}},[]),r=n(t);if(!r){console.error(`Category not found: ${t}`);return}let i=document.createElement(`div`),a=document.createElement(`main`),o=document.createElement(`div`),h=document.createElement(`div`);a.className=`pt-24 pb-20`,i.innerHTML=s(),o.innerHTML=d(),h.innerHTML=e(),document.body.insertBefore(i,document.querySelector(`main`)||document.body.firstChild);let g=document.getElementById(`category-page-root`);a.innerHTML=m(r),g.replaceWith(a),document.body.appendChild(h),document.body.appendChild(o),c(),l(),u(),f();let _=(await p(async()=>{let{categoryPageAnimation:e}=await import(`./categoryAnimation-CGr_VJLK.js`);return{categoryPageAnimation:e}},__vite__mapDeps([0,1]))).categoryPageAnimation;_()}export{h as t};