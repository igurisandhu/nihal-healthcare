...
import{n as e,t}from"./footer-CFOVKqMt.js";import{t as n}from"./navbarAnimation-BVUa5AKH.js";import{t as r}from"./navbarFunctionality-BGGaZaf6.js";import{t as i}from"./footerAnimation-VMZc8zZ3.js";import{c as a,d as o,f as s,l as c,m as l,o as u,t as d}from"./seoMeta-DNj-lsNH.js";import{t as f}from"./preload-helper-CanIyeJJ.js";var p=`919218511425`,m={"sterile-hypodermic-syringes":{"1ml-syringe-with-needle":`https://picsum.photos/800/600?random=111`,"2ml-syringe-with-needle":`https://picsum.photos/800/600?random=112`,"3ml-syringe-with-needle":`https://picsum.photos/800/600?random=113`,"5ml-syringe-with-needle":`https://picsum.photos/800/600?random=114`,"10ml-syringe-with-needle":`https://picsum.photos/800/600?random=115`,"20ml-syringe-with-needle":`https://picsum.photos/800/600?random=116`,"50ml-syringe-with-needle":`https://picsum.photos/800/600?random=117`},"sterile-hypodermic-syringes-without-needle":{"1ml-syringe-without-needle":`https://picsum.photos/800/600?random=121`,"2ml-syringe-without-needle":`https://picsum.photos/800/600?random=122`,"3ml-syringe-without-needle":`https://picsum.photos/800/600?random=123`,"5ml-syringe-without-needle":`https://picsum.photos/800/600?random=124`,"10ml-syringe-without-needle":`https://picsum.photos/800/600?random=125`,"20ml-syringe-without-needle":`https://picsum.photos/800/600?random=126`,"50ml-syringe-without-needle":`https://picsum.photos/800/600?random=127`},"sterile-hypodermic-needles":{"16g-hypodermic-needle":`https://picsum.photos/800/600?random=131`,"18g-hypodermic-needle":`https://picsum.photos/800/600?random=132`,"20g-hypodermic-needle":`https://picsum.photos/800/600?random=133`,"21g-hypodermic-needle":`https://picsum.photos/800/600?random=134`,"22g-hypodermic-needle":`https://picsum.photos/800/600?random=135`,"23g-hypodermic-needle":`https://picsum.photos/800/600?random=136`,"24g-hypodermic-needle":`https://picsum.photos/800/600?random=137`,"25g-hypodermic-needle":`https://picsum.photos/800/600?random=138`,"26g-hypodermic-needle":`https://picsum.photos/800/600?random=139`}};function h(e){let t=c(p,e),n=m[e.categoryId]?.[e.slug]||`https://images.unsplash.com/photo-1584308666744-24d5f15714ae?w=800&h=600&fit=crop`,r=e.needleGauges?e.needleGauges.map(t=>`
        <a 
          href="${c(p,e,null,t)}"
          target="_blank"
      ...
      `).join(``):``,i=[{label:`Material`,value:e.materials?.join(`, `)},{label:`Sterilization`,value:e.sterilization},{label:`Classification`,value:e.classification},{label:`EMDN Code`,value:e.emdnCode},{label:`GMDN Code`,value:e.gmdnCode},{label:`UDI-DI`,value:e.udiDi},{label:`MDN Code`,value:e.mdn},{label:`MDS Codes`,value:e.mds?.join(`, `)},{label:`MDT Codes`,value:e.mdt?.join(`, `)}].map((e,t)=>`
  ...
  `}async function g(c){let{getVariantBySlug:p}=await f(async()=>{let{getVariantBySlug:e}=await import(`./productsDatabase-MIzzNIzA.js`).then(e=>e.n);return{getVariantBySlug:e}},[]),m=p(c);if(!m){console.error(`Variant not found: ${c}`);return}o(u(m,!0)),s([a(m),d([{name:`Home`,url:`/`},{name:`Products`,url:`/products.html`},{name:m.categoryName,url:`/products/${m.categoryId}.html`},{name:m.name,url:`/products/${m.categoryId}/${c}.html`}])]);let g=document.createElement(`div`),_=document.createElement(`main`),v=document.createElement(`div`);_.className=`pt-24 pb-20`,g.innerHTML=e(),v.innerHTML=t(),document.body.insertBefore(g,document.querySelector(`main`)||document.body.firstChild);let y=document.getElementById(`variant-detail-root`);_.innerHTML=h(m),y.replaceWith(_),document.body.appendChild(v),n(),r(),i(),l();let b=(await f(async()=>{let{variantDetailAnimation:e}=await import(`./variantDetailAnimation-_1X8grQM.js`);return{variantDetailAnimation:e}},__vite__mapDeps([0,1]))).variantDetailAnimation;b()}export{g as t};