import{_ as e,b as t,c as n,d as r,h as i,i as a,s as o,t as s,y as c}from"./gtm-O4LoftQe.js";import{n as l,t as u}from"./ScrollTrigger-N39Bzxb5.js";import{t as d}from"./navbarAnimation-BVUa5AKH.js";import{t as f}from"./navbarFunctionality-BGGaZaf6.js";import{n as p,t as m}from"./productsAnimation-Ds_RcrJt.js";import{n as h,t as g}from"./leadershipAnimation-D-WJbRQI.js";import{n as _,t as v}from"./feedback-CKdOT7rd.js";import{t as y}from"./footerAnimation-VMZc8zZ3.js";import{n as b,t as x}from"./certificationsAnimations-uettMGoJ.js";import{t as S}from"./blogsGrid-DYXSboR-.js";import{i as C,n as w,r as T,t as E}from"./faqAnimation-Bq_bPf-C.js";import{n as D,t as O}from"./pageMetadata-BtsBSRlY.js";import{t as k}from"./whatsappButtonFunctionality-Dv5HATDW.js";var A=`/assets/hero-1-DP918TK8.jpg`,j=`/assets/hero-2-DwOaF9jL.avif`,M=`/assets/hero-3-ejHO0v_v.avif`,N=`/assets/hero-4-DLpmizSW.jpg`,P=()=>`
  ...
  `,F=()=>{l.timeline().from(`.hero-title`,{y:100,opacity:0,duration:1,ease:`power4.out`}).from(`.hero-desc`,{y:40,opacity:0,duration:.8},`-=0.5`).from(`#hero-image`,{scale:1.2,opacity:0,duration:1.2,ease:`power4.out`},`-=0.8`)},I=()=>{let e=document.querySelector(`#hero-image`),t=[A,j,M,N],n=0;setInterval(()=>{n++,n>=t.length&&(n=0),e.style.opacity=0,setTimeout(()=>{e.src=t[n],e.style.opacity=1},300)},2e3)};l.registerPlugin(u);var L=()=>{window.innerWidth>=1024&&l.from(`.testimonial-card`,{y:80,opacity:20,stagger:.2,duration:1,ease:`power4.out`,scrollTrigger:{trigger:`.testimonials-section`,start:`top 75%`}})},R=()=>`
  ...
  `;l.registerPlugin(u);var z=()=>{window.innerWidth>=1024&&l.from(`.contact-cta-title`,{y:80,opacity:0,duration:1,ease:`power4.out`,scrollTrigger:{trigger:`.contact-cta-section`,start:`top 75%`}})},B=()=>`
  ...
  `,V=()=>{let e=document.querySelectorAll(`.rating-star`);e.forEach((t,n)=>{t.addEventListener(`click`,()=>{e.forEach((e,t)=>{t<=n?(e.classList.remove(`text-slate-300`),e.classList.add(`text-yellow-400`)):(e.classList.remove(`text-yellow-400`),e.classList.add(`text-slate-300`))})})});let t=document.querySelectorAll(`.feedback-option`);t.forEach(e=>{e.addEventListener(`click`,()=>{t.forEach(e=>{e.classList.remove(`bg-slate-900`,`text-white`),e.classList.add(`bg-stone-50`,`text-slate-700`)}),e.classList.remove(`bg-stone-50`,`text-slate-700`),e.classList.add(`bg-slate-900`,`text-white`)})}),document.querySelectorAll(`.feedback-tag`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.toggle(`bg-cyan-500`),e.classList.toggle(`text-white`),e.classList.toggle(`bg-cyan-50`),e.classList.toggle(`text-cyan-600`)})})};l.registerPlugin(u);var H=()=>{l.from(`.blogs-grid-section h2, .blogs-grid-section h1`,{opacity:20,y:60,duration:1,ease:`power3.out`}),l.from(`.blogs-grid-section p`,{opacity:20,y:40,duration:1,delay:.2,ease:`power3.out`}),l.from(`.blogs-grid-section .group`,{scrollTrigger:{trigger:`.blogs-grid-section`,start:`top 75%`},opacity:20,y:80,stagger:.2,duration:1,ease:`power3.out`}),l.from(`.single-blog-image`,{scrollTrigger:{trigger:`.single-blog-image`,start:`top 80%`},opacity:20,scale:.9,duration:1.2,ease:`power3.out`}),l.from(`.single-blog-content p`,{scrollTrigger:{trigger:`.single-blog-content`,start:`top 80%`},opacity:20,y:50,stagger:.2,duration:1,ease:`power3.out`})};s(),i(O(`home`)),e([r({baseUrl:`https://nihalhealthcare.com`,phone:`+919218511425`,email:`contact@nihalhealthcare.com`,whatsapp:`+919218511425`}),n(`https://nihalhealthcare.com`),o(T),a([{name:`Home`,url:`https://nihalhealthcare.com/`}])]),document.querySelector(`#app`).innerHTML=`
  ${t()}
  ${P()}
  ${D()}
  ${p()}
