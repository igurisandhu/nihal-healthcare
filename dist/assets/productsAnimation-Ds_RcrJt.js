import{t as e}from"./productsDatabase-MIzzNIzA.js";import{n as t,t as n}from"./ScrollTrigger-N39Bzxb5.js";var r=()=>`
  ...
  `,i={"sterile-hypodermic-syringes":`/assets/images/products/sterile-hypodermic-syringes-with-needle.png`,"sterile-hypodermic-syringes-without-needle":`/assets/images/products/sterile-hypodermic-syringes-without-needle.png`,"sterile-hypodermic-needles":`/assets/images/products/sterile-hypodermic-needles.png`},a=()=>{let{categories:t}=e;return`
    ${r()}
          ...
          ${t.map(e=>`
            ...
            >
              ...
              <div class="relative h-[240px] sm:h-[280px] overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                <img 
                  src="${i[e.slug]||`https://images.unsplash.com/photo-1584308666744-24d5f15714ae?w=600&h=400&fit=crop`}"
                  alt="${e.name}"
  ...
  `};t.registerPlugin(n);var o=()=>{window.innerWidth>=1024&&t.from(`.product-card`,{y:80,opacity:20,stagger:.2,duration:1,ease:`power4.out`,scrollTrigger:{trigger:`.products-section`,start:`top 75%`}})};export{a as n,o as t};