...
Thank you!`;return encodeURIComponent(l)},l=(e,t,n=null,r=null)=>`https://wa.me/${e}?text=${c(t,n,r)}`,u=(e={})=>{let t=e.baseUrl||`https://nihalhealthcare.com`,n=e.phone||`+919218511425`,r=e.email||`contact@nihalhealthcare.com`;return e.whatsapp,{"@context":`https://schema.org`,"@type":`Organization`,name:`Nihal Healthcare`,url:t,logo:`${t}/assets/nihal-healthcare-logo.png`,description:`Leading manufacturer and supplier of sterile medical syringes and hypodermic needles. ISO 13485 certified. ETO sterilized medical devices.`,foundingDate:`2007`,foundingLocation:`India`,contactPoint:{"@type":`ContactPoint`,name:`Customer Service`,telephone:n,contactType:`Customer Service`,email:r,areaServed:`IN`,availableLanguageId:`en`},address:{"@type":`PostalAddress`,addressCountry:`IN`,addressLocality:`India`,addressRegion:`India`}}},d=(e={})=>({"@context":`https://schema.org`,"@type":`ContactPoint`,name:`Nihal Healthcare - Customer Support`,telephone:e.phone||`+919218511425`,email:e.email||`contact@nihalhealthcare.com`,contactType:`Customer Service`,areaServed:`IN`,availableLanguageId:`en`}),f=(e={})=>{let t=e.baseUrl||`https://nihalhealthcare.com`,n=e.phone||`+919218511425`,r=e.email||`contact@nihalhealthcare.com`;return{"@context":`https://schema.org`,"@type":`LocalBusiness`,name:`Nihal Healthcare`,description:`Manufacturer and supplier of sterile medical devices - syringes and hypodermic needles. ISO 13485 certified.`,url:t,telephone:n,email:r,image:`${t}/assets/nihal-healthcare-logo.png`,address:{"@type":`PostalAddress`,addressCountry:`IN`,addressLocality:`India`},contactPoint:{"@type":`ContactPoint`,name:`Customer Service`,telephone:n,contactType:`Customer Service`,email:r}}},p=(e,t=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`BlogPosting`,headline:e.title,description:e.description,image:e.image||`${t}/assets/placeholder-blog.jpg`,datePublished:e.publishedDate,dateModified:e.modifiedDate||e.publishedDate,author:{"@type":`Organization`,name:e.author||`Nihal Healthcare`},publisher:{"@type":`Organization`,name:`Nihal Healthcare`,logo:{"@type":`ImageObject`,url:`${t}/assets/nihal-healthcare-logo.png`}},mainEntityOfPage:{"@type":`WebPage`,"@id":e.url||`${t}/blogs`},keywords:e.keywords,wordCount:e.wordCount,articleSection:e.category||`Healthcare News`,url:e.url||`${t}/blogs`}),m=(e=[],t=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`FAQPage`,mainEntity:e.map(e=>({"@type":`Question`,name:e.question,acceptedAnswer:{"@type":`Answer`,text:e.answer}}))}),h=(e,t=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`BreadcrumbList`,itemListElement:e.map((e,n)=>({"@type":`ListItem`,position:n+1,name:e.name,item:e.url.startsWith(`http`)?e.url:`${t}${e.url}`}))}),g=(e=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`WebSite`,name:`Nihal Healthcare`,url:e,description:`Leading manufacturer of sterile medical devices - syringes and hypodermic needles. ISO 13485 certified.`,potentialAction:{"@type":`SearchAction`,target:{"@type":`EntryPoint`,urlTemplate:`${e}/products?search={search_term}`}}}),_=e=>{e.title&&(document.title=e.title),document.querySelectorAll(`meta[data-seo="true"]`).forEach(e=>e.remove());let t=(e,t,n=!1)=>{if(!t)return;let r=n?`property`:`name`,i=document.querySelector(`meta[${r}="${e}"]`);i||(i=document.createElement(`meta`),i.setAttribute(r,e),i.setAttribute(`data-seo`,`true`),document.head.appendChild(i)),i.setAttribute(`content`,t)};t(`description`,e.description),t(`keywords`,e.keywords),t(`robots`,e.robots||`index, follow`),t(`author`,e.author),t(`viewport`,e.viewport||`width=device-width, initial-scale=1.0`),t(`og:title`,e.ogTitle||e.title,!0),t(`og:description`,e.ogDescription||e.description,!0),t(`og:image`,e.ogImage,!0),t(`og:url`,e.ogUrl||e.canonical,!0),t(`og:type`,e.ogType||`website`,!0),t(`og:locale`,e.ogLocale||`en_US`,!0),t(`og:logo`,e.ogLogo||`https://nihalhealthcare.com/assets/images/nihal-healthcare-logo.png`,!0),t(`og:site_name`,e.ogSiteName||`Nihal Healthcare`,!0),t(`twitter:card`,e.twitterCard||`summary_large_image`),t(`twitter:title`,e.twitterTitle||e.ogTitle||e.title),t(`twitter:description`,e.twitterDescription||e.ogDescription||e.description),t(`twitter:image`,e.twitterImage||e.ogImage);let n=document.querySelector(`link[rel="canonical"]`);n||(n=document.createElement(`link`),n.rel=`canonical`,document.head.appendChild(n)),n.href=e.canonical,o()},v=e=>{document.querySelectorAll(`script[type="application/ld+json"][data-seo="true"]`).forEach(e=>e.remove()),e.forEach(e=>{let t=document.createElement(`script`);t.type=`application/ld+json`,t.setAttribute(`data-seo`,`true`),t.textContent=JSON.stringify(e,null,2),document.head.appendChild(t)})},y=(e,t=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`BreadcrumbList`,itemListElement:e.map((e,n)=>({"@type":`ListItem`,position:n+1,name:e.name,item:e.url?e.url.startsWith(`http`)?e.url:`${t}${e.url}`:void 0}))}),b=(e,t=`https://nihalhealthcare.com`)=>({"@context":`https://schema.org`,"@type":`ItemList`,name:`Nihal Healthcare Medical Products`,description:`Complete range of ISO 13485 certified sterile medical devices — syringes and hypodermic needles.`,numberOfItems:e.length,itemListElement:e.map((e,n)=>({"@type":`ListItem`,position:n+1,item:{"@type":`Product`,name:e.name,description:e.description,url:e.url.startsWith(`http`)?e.url:`${t}${e.url}`,image:e.image||`${t}/assets/images/brand/og-image-nihal-healthcare-logo.jpg`,brand:{"@type":`Brand`,name:`Nihal Healthcare`},manufacturer:{"@type":`Organization`,name:`Nihal Healthcare`,url:t},offers:{"@type":`Offer`,priceCurrency:`INR`,availability:`https://schema.org/InStock`,url:e.url.startsWith(`http`)?e.url:`${t}${e.url}`}}}))}),x=`G-NEDBHTPNWH`,S=()=>{if(document.querySelector(`script[src*="${x}"]`))return;let e=document.createElement(`script`);e.async=!0,e.src=`https://www.googletagmanager.com/gtag/js?id=${x}`,document.head.appendChild(e);let t=document.createElement(`script`);t.textContent=`
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', '${x}');
  `,document.head.appendChild(t)};export{s as _,i as a,g as c,u as d,b as f,v as g,_ as h,y as i,f as l,l as m,h as n,d as o,r as p,p as r,m as s,S as t,a as u,n as v,t as y};