...
export const pageMetadata = {
  home: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-home.jpg`,
    canonical: BASE_URL,
  },
  about: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-about.jpg`,
  ...
  products: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-products.jpg`,
  ...
  contact: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-contact.jpg`,
  ...
  blogs: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-blogs.jpg`,
  ...
  certifications: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-certifications.jpg`,
  ...
  leadership: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-leadership.jpg`,
  ...
  history: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-history.jpg`,
  ...
  feedback: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-feedback.jpg`,
  ...
  disposableSyringes: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-disposable-syringes.jpg`,
  ...
  safetySyringes: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-safety-syringes.jpg`,
  ...
  insulinSyringes: {
    ...
    ogType: 'website',
    ogImage: `${BASE_URL}/assets/og-image-insulin-syringes.jpg`,
...
export const getPageMetadata = (pageName) => {
  ...
  return {
    ...
    ogImage: metadata.ogImage || `${BASE_URL}/assets/og-image.jpg`,
