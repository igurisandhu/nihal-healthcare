...
export const pageMetadata = {
  home: {
    ...
    keywords: 'sterile syringes, hypodermic needles, medical devices, CE, ETO sterilization, bulk medical supplies, healthcare products',
    ogType: 'website',
    ogImage: OG_IMAGE,
    canonical: `${BASE_URL}/`,
  },
  about: {
    ...
    keywords: 'about nihal healthcare, medical device manufacturer, CE, company mission, healthcare innovation, sterile manufacturing',
    ogType: 'website',
    ogImage: OG_IMAGE,
  ...
  certifications: {
    ...
    description: 'Nihal Healthcare holds CE, CE marking, and other international certifications ensuring highest quality standards in medical device manufacturing.',
    keywords: 'CE, CE marking, medical device certifications, compliance, quality standards, regulatory certifications',
    ogType: 'website',
    ogImage: OG_IMAGE,
  ...
  sterileManufacturing: {
    ...
    keywords: 'sterile manufacturing, healthcare manufacturing, CE, ETO sterilization, medical device quality',
    ogType: 'article',
    ogImage: OG_IMAGE,
    ...
    articleKeywords: 'sterile manufacturing, healthcare manufacturing, CE, ETO sterilization',
  },
  healthcareInnovation: {
    ...
    keywords: 'healthcare innovation, medical engineering, medical device manufacturing, precision engineering, CE',
    ogType: 'article',
    ogImage: OG_IMAGE,
  ...
  medicalSafety: {
    ...
    keywords: 'medical safety standards, healthcare compliance, sterile medical devices, CE, patient safety',
    ogType: 'article',
    ogImage: OG_IMAGE,
